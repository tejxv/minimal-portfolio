...
import NowInBengaluru from "./now-in-bengaluru"
    ...
    <footer className="mb-16">
      ...
      <ul className="font-sm mt-8 flex flex-col text-neutral-500 md:flex-row md:space-y-0">
        {socialLinks.map((link) => (
          <li key={link.name}>
            <a
              className="flex px-2 py-1 items-center rounded-full group transition-all sm:hover:shadow-sm sm:hover:text-white sm:hover:bg-blue-500"
